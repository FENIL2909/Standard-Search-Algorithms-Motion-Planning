...
if __name__ == "__main__":
    # Load the map
    start = (200, 75)  #(200,75)    #(275,50)
    goal  = (30, 250)  #(30,250)    #(90,230)
    ...
    PRM_planner.sample(n_pts=2000, sampling_method="random")
    PRM_planner.search(start, goal)
    PRM_planner.sample(n_pts=5000, sampling_method="gaussian")
    PRM_planner.search(start, goal)
    PRM_planner.sample(n_pts=30000, sampling_method="bridge") #60000    #120000   #30000
    PRM_planner.search(start, goal)

    # Search with RRT and RRT*
    RRT_planner.RRT(n_pts=1000) #1000 #2000
    RRT_planner.RRT_star(n_pts=2000) #2000 #4000
